...
class MysqlQueryBuilder implements QueryBuilder
{
    ...
    {
        $this->sql .= " JOIN {$table} ON {$first} {$op} {$second}";
    ...
    {
        $this->sql .= " LEFT JOIN {$table} ON {$first} {$op} {$second}";
    ...
    public function rightJoin(string $table, string $first, string $op, string $second): static
    {
        ...
        $this->sql .= " RIGHT JOIN {$table} ON {$first} {$op} {$second}";
    ...
    public function innerJoin(string $table, string $first, string $op, string $second): static
    {
        ...
        $this->sql .= " INNER JOIN {$table} ON {$first} {$op} {$second}";
    ...
    {
        $this->sql .= " OUTER JOIN {$table} ON {$first} {$op} {$second}";
